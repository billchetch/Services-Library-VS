...
namespace Chetch.Services
{
    abstract public class TCPMessagingClient : ChetchMessagingClient
    {
        ...
        public TCPMessagingClient(String cmSourceName, String sourceName, String logName) : base(sourceName, logName)
        {
            _cmSourceName = cmSourceName;
        }

        protected override ClientConnection ConnectClient()
        {
